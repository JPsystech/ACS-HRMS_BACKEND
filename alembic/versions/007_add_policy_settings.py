...
def upgrade() -> None:
    ...
    if is_sqlite:
        ...
        op.create_table(
            ...
            sa.Column('cl_pl_monthly_cap', sa.Numeric(5, 2), nullable=False, server_default='4.0'),
            sa.Column('weekly_off_day', sa.Integer(), nullable=False, server_default='7'),
            sa.Column('sandwich_enabled', sa.Boolean(), nullable=False, server_default='true'),
            sa.Column('sandwich_include_weekly_off', sa.Boolean(), nullable=False, server_default='true'),
            sa.Column('sandwich_include_holidays', sa.Boolean(), nullable=False, server_default='true'),
            sa.Column('sandwich_include_rh', sa.Boolean(), nullable=False, server_default='false'),
            sa.Column('allow_hr_override', sa.Boolean(), nullable=False, server_default='true'),
            sa.Column(
                'created_at',
