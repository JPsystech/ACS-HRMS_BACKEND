...
api_router.include_router(culture.router, tags=["culture"])
...
api_router.include_router(attendance_corrections.router, prefix="/attendance-corrections", tags=["attendance-corrections"])
