...
class PolicySetting(Base):
    ...
    annual_fl = Column(Integer, nullable=False, default=1)
    ...
    # 2026 final rules: Jan–Oct credit CL; Nov–Dec credit FL; PL/SL credit every month; each at +0.5
    monthly_credit_pl = Column(Numeric(5, 2), nullable=False, default=0.5)
    monthly_credit_cl = Column(Numeric(5, 2), nullable=False, default=0.5)
    monthly_credit_sl = Column(Numeric(5, 2), nullable=False, default=0.5)
